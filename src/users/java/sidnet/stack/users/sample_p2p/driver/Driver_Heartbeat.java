...
import static sidnet.stack.users.sample_p2p.driver.Driver_SampleP2P.battery;
import static sidnet.stack.users.sample_p2p.driver.Driver_SampleP2P.createNode;
import static sidnet.stack.users.sample_p2p.driver.Driver_SampleP2P.eCostParam;
import static sidnet.stack.users.sample_p2p.driver.Driver_SampleP2P.topologyGUI;
