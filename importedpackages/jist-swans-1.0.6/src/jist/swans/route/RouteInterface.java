...
public interface RouteInterface extends NetInterface.NetHandler, JistAPI.Proxiable
{
   ...
   * NWU routing entity interface.
   */
  public static interface DharmawanRoute extends RouteInterface, Protocol
  {
  ...
  {
      public void epochConditionCompleted(Message msgAggr, Object incomingAggregationBean);
